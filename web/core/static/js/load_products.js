    ...
    fetch(apiProductosUrl)
        ...
        .then(productos => {
            ...
            productosToShow.forEach(producto => {
                ...
                // CAMBIO CLAVE AQUÍ: Envolvemos la tarjeta en un enlace <a>
                colDiv.innerHTML = `
                        ...
                        <a href="/shop-detail/${producto.id}/" class="text-decoration-none text-dark d-flex flex-column h-100">
                            ...
                            <div class="p-4 border border-warning border-top-0 rounded-bottom d-flex flex-column flex-grow-1">
                                ...
                                <div class="d-flex justify-content-between flex-wrap mt-auto">
                                    ...
                                    <a href="#" class="btn border border-secondary rounded-pill px-2 text-primary" onclick="event.stopPropagation(); alert('¡Producto ${producto.nombre} añadido al carrito!');">
